...
func run() -> Array[String]:
	...
	var ui_keys: Dictionary[String, StringName] = {
		...
		"loadout shield backup slot": &"UI_LOADOUT_SLOT_SHIELD_BACKUP_POWER",
		...
		"loadout requirements summary": &"UI_LOADOUT_REQUIREMENTS_SUMMARY_FORMAT",
		"loadout standard issue note": &"UI_LOADOUT_STANDARD_ISSUE_NOTE",
		"observation dismissal hint": &"UI_OBSERVATION_DISMISS_HINT",
